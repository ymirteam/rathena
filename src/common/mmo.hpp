...
#define MAX_SLOTS 4
#define MAX_AMOUNT 32000 ////Max amount of a single stacked item
...
#define MAX_SKILL 2500 ///Maximum skill can be hold by Player, Homunculus, & Mercenary (skill list) AND skill_db limit
